...
do {
    ...
    if (isNaN(numero)){
        console.log('O valor informado nao é valido! Tente novamente. \n');
    }
...
if (count == 2){
    console.log('Este numero e primo, ele so pode ser dividido por 1 e por ele mesmo');
}
}
